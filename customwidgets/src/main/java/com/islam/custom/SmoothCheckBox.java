...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        canUncheck = ta.getBoolean(R.styleable.SmoothCheckBox_can_uncheck, true);
        isSquare = ta.getBoolean(R.styleable.SmoothCheckBox_is_square, true);
    ...
    private void drawCenter(Canvas canvas) {
        ...
        else canvas.drawRect(mCenterPoint.x-radius,
                mCenterPoint.y-radius,
                mCenterPoint.x+radius,
                mCenterPoint.y+radius,
                mPaint);
    }
