...
package com.islam.custom.materialratingbar;
...
import com.islam.custom.R;
import com.islam.custom.materialratingbar.internal.DrawableCompat;
...
public class MaterialRatingBar extends RatingBar {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyDrawable = a.getResourceId(R.styleable.MaterialRatingBar_mrb_drawableEmpty,R.drawable.ic_rate_border);
        mFilledDrawable =a.getResourceId(R.styleable.MaterialRatingBar_mrb_drawableFilled,R.drawable.ic_rate_fill);
        mEnabled =a.getBoolean(R.styleable.MaterialRatingBar_mrb_enabled,true);
        boolean fillBackgroundStars = a.getBoolean(
                R.styleable.MaterialRatingBar_mrb_fillBackgroundStars, isIndicator());
        a.recycle();

        mDrawable = new MaterialRatingDrawable(getContext(),mFilledDrawable,mEmptyDrawable, fillBackgroundStars);
