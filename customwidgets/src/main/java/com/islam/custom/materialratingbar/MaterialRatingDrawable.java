...
import com.islam.custom.materialratingbar.internal.ThemeUtils;

public class MaterialRatingDrawable extends LayerDrawable {

    Drawable[] layers = null;

    public MaterialRatingDrawable(Context context,int rateFill, int rateBorder, boolean fillBackgroundStars) {
        super(new Drawable[]{
                createLayerDrawableWithTintAttrRes(
                        fillBackgroundStars ?rateFill:rateBorder,
                ...
                fillBackgroundStars ? createClippedLayerDrawableWithTintColor(
                        rateFill,Color.TRANSPARENT, context):
                        createClippedLayerDrawableWithTintAttrRes(rateBorder,R.attr.colorControlActivated,context),
                createClippedLayerDrawableWithTintAttrRes(rateFill,R.attr.colorControlActivated,context)
        });
