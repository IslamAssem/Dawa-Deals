...
import static com.islam.custom.patternedTextWatcher.Preconditions.checkInput;
import static com.islam.custom.patternedTextWatcher.Preconditions.checkPatternInInput;
import static com.islam.custom.patternedTextWatcher.Preconditions.checkPatternInput;
...
public class PatternedTextWatcher implements TextWatcher {
  ...
  private boolean areThereCharsLeftToReplace(StringBuilder sb) {
      return normalCharactersByIndex.get(sb.length()) != null;
  }
