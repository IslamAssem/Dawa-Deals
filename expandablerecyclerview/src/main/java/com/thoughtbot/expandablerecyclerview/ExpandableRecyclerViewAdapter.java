...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    public void scrollToGroup(int flatPos){
        Log.e("scrollToPos"," : "+flatPos);
        flatPos = expandableList.getUnflattenedPosition(flatPos).groupPos;
        Log.e("scrollToPos"," getUnflattenedPosition : "+flatPos);
        if (recyclerView!=null){
            if(recyclerView.getLayoutManager() instanceof LinearLayoutManager)
                ((LinearLayoutManager)recyclerView.getLayoutManager()).scrollToPositionWithOffset(flatPos,0);
