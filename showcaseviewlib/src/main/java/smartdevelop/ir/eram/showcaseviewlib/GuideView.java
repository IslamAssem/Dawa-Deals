...
public class GuideView extends FrameLayout {
    ...
    private int   messageViewPadding=10;
    private float marginGuide=10;
    private float strokeCircleWidth=10;
    private float indicatorHeight=10;
    ...
    private GuideView(Context context, View view) {
        ...
        if (mBackground!=null)
            mMessageView.setBackground(mBackground);
...
//            if (mBackground!=null){
//                mBackground.setBounds((int)x,
//                        (int) startYLineAndCircle,
//                        (int) x,
//                        (int) stopY);//(int)targetRect.left,(int)targetRect.top,(int)targetRect.right,(int)targetRect.bottom);
...
//            }
    ...
    public GuideMessageView getMessageView() {
        return mMessageView;
    }
