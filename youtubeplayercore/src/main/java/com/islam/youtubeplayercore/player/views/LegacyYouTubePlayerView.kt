package com.islam.youtubeplayercore.player.views
...
import com.islam.youtubeplayercore.R
...
import com.islam.youtubeplayercore.player.listeners.YouTubePlayerFullScreenListener
import com.islam.youtubeplayercore.player.listeners.YouTubePlayerCallback
import com.islam.youtubeplayercore.player.listeners.YouTubePlayerListener
import com.islam.youtubeplayercore.player.options.IFramePlayerOptions
import com.islam.youtubeplayercore.player.utils.FullScreenHelper
import com.islam.youtubeplayercore.player.utils.PlaybackResumer
import com.islam.youtubeplayercore.ui.DefaultPlayerUiController
import com.islam.youtubeplayercore.ui.PlayerUiController
import com.islam.youtubeplayercore.player.utils.NetworkListener
...
internal class LegacyYouTubePlayerView(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0):
    ...
    fun initialize(youTubePlayerListener: YouTubePlayerListener, handleNetworkEvents: Boolean, playerOptions: IFramePlayerOptions?) {
        ...
        if (handleNetworkEvents)
            context.registerReceiver(networkListener, IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"))
